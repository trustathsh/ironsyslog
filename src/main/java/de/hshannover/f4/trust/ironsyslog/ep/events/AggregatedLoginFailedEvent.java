...
/**
 * Event representing an aggregation of failed logins on a remote machine.
 * 
 * @author Leonard Renners
 * 
 */
public class AggregatedLoginFailedEvent extends Event {
     ...
     */
    public AggregatedLoginFailedEvent(String userId, String userIp,
            String serviceHost, String serviceName, boolean isValidUser,
            int count) {
        super();
        setUserId(userId);
        setUserIp(userIp);
